...
<nav style="--bs-breadcrumb-divider: '>';" aria-label="breadcrumb">
        <ol class="breadcrumb">
            ...
            <li class="breadcrumb-item active" aria-current="page">Womens Collection</li>
        </ol>
    </nav>
    ...
    <div id="carouselExampleInterval" class="carousel slide carousel-dark " data-bs-ride="carousel">
        ...
        <div class="carousel-inner">
            <div class="carousel-item active" data-bs-interval="10000">
                <img src="Themes/sarah-dorweiler-fr0J5-GIVyg-unsplash.jpg" height="450px"
                    style="width: 70%;margin-left: auto;margin-right: auto;" class="d-block " alt="">
            ...
            <div class="carousel-item" data-bs-interval="2000">
                ...
                <div class="carousel-caption d-none d-md-block" style="color: white;">
                    ...
                    <a href="featured-product.html"> <button type="button" class="btn btn-success">Click
                            here</button></a>
                </div>
            </div>
        ...
        <div class="container text-center text-md-left">
            <div class="row text-center text-md-left">
                ...
                <div class="col-md-3 col-lg-2 col-xl-2 mx-auto mt-3">
                    ...
                    <p>
                        <a href="https://www.facebook.com/profile.php?id=100068270438692&mibextid=ZbWKwL"
                            class="text-white" style="text-decoration: none;">Facebook</a>
                    </p>
                    <p>
